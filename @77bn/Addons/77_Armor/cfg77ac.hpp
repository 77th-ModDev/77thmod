class 77th_ODST_VestR: 77th_ODST_Vest
    {
		...
		hiddenSelectionsTextures[]=
		{
			...
			"\77_Armor\Data\Armor\77_odst_hard_co.paa",
	...
	class 77th_ODST_VestM: 77th_ODST_Vest
    {
        ...
        author="77 SMU/ODST";
        picture="\optre_unsc_units\army\icons\odst_vest.paa";
        displayName="[77th] M52D Body Armor (Messenger)";
        model = "\OPTRE_UNSC_Units\Army\armor.p3d";     
        hiddenSelections[] = {
		"camo",
		"camo2",
	...
	class 77th_ODST_VestSK: 77th_ODST_Vest
    {
        dlc="77";
		scope = 2;
        author="77 SMU/ODST";
        picture="\optre_unsc_units\army\icons\odst_vest.paa";
        displayName="[77th] M52D Body Armor (Scotched)";
        model = "\OPTRE_UNSC_Units\Army\armor.p3d";        
       hiddenSelections[] = {
		"camo",
		"camo2",
