...
CSW_fnc_TaserOnHit = compileFinal preProcessFileLineNumbers "\77_Weapons\scripts\fnc_TaserOnHit.sqf";
CSW_fnc_TaserOnRespawn = compileFinal preProcessFileLineNumbers "\77_Weapons\scripts\fnc_TaserOnRespawn.sqf";
